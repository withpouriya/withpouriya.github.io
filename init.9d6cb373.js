...
var gameState = {
  ...
  die: function die() {
    ...
    (0, _ui.modFox)("dead");
    this.clearTimes();
    (0, _ui.writeModal)("روباهی از دست رفت 🙁");
  }
};
var handleUserAction = gameState.handleUserAction.bind(gameState);
